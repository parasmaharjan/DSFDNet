...
parser.add_argument('--o_colors', type=int, default=4,
...
test_name = 'combine_all_edsr_only/'
...
for epoch in range(lastepoch, 4001):
    ...
    for ind in np.random.permutation(len(train_ids)):
        ...
        if input_images[str(ratio)[0:3]][ind] is None:
            ...
            gt_images[ind] = np.expand_dims(pack_raw(gt_raw), axis=0)
        ...
        if epoch % save_freq == 0:
            ...
            torch.save(model.state_dict(), model_dir + test_name + 'combine_all_edsr_only_sony_e%04d.pth' % epoch)